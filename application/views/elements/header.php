...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/icon/smalllogo-237x104-42.png" type="image/x-icon">
  <title>MEDIKAPLAZA | MAS</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Medika</b>Plaza</span>
    </a>
